 ...
 */
export default function getElementContentWidthAndHeight(element: HTMLElement): { width: number; height: number } {
  ...
  return { width: element.offsetWidth - paddingX - borderX, height: element.offsetHeight - paddingY - borderY };
}
