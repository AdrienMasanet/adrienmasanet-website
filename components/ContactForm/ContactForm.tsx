  ...
  const submitMessage = async (event: React.FormEvent) => {
    ...
    if (success) {
      ...
      setErrorStrings([
        ...
        "Mes Oompa Loompa sont sur le coup, pas de panique !",
      ]);
    }
  };
    ...
    <>
      ...
      <form
        className={`${styles.container} ${
          formSubmitted ? styles.submitted : ""
        }`}
        name="message"
      ...
      >
        <div className={styles.inlineinputs}>
          <input
            className={`${styles.formelement} ${styles.inputname}`}
            type="email"
            name="email"
            id="email"
          ...
          />
          <input
            className={`${styles.formelement} ${styles.inputcompany}`}
            type="text"
            name="company"
            id="company"
        ...
        <div
          className={`${styles.error} ${
            errorStrings.length > 0 ? styles.active : ""
          }`}
        >
